...
("The Lit" research paper browser): ABS 3 journals in Operations/OR and Economics.
...
- publishes `/data/` on this repo's GitHub Pages site — served under
  `https://www.stouras.com/lit-data-abs3-omecon/data/`, the same origin as the lit
