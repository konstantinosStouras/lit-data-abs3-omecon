/*
 * build-data.mjs — the lit-data-abs3-omecon data pipeline (a lit satellite data shard).
 * ===========================================================================
 * This repo is a SATELLITE DATA SHARD for stouras.com/fun/lit/ ("The Lit"):
 * ABS 3 journals in Operations/OR and Economics.
 ...
 * stouras.com/lit-data-abs3-omecon/data/, same origin as the lit page), and the lit
...
async function main() {
  ...
  const meta = {
    ...
    source: 'Crossref REST API, one pull per journal (ABS 3 journals in Operations/OR and Economics)',
  };
